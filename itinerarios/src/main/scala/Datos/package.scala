...
package object Datos {
  ...
  /**
      * @param cod codigo del aeropuerto
      * @param x coordenada x del aeropuerto
      * @param y coordenada y del aeropuerto
      * @param gmt diferencia horaria con respecto a GMT
      * Ejemplo: Aeropuerto("clo", 100, 300, 8)
    */
  case class Aeropuerto(cod: String, x: Int, y: Int, gmt: Int)
  
  /**
      * @param aln aerolinea
      * @param num numero de vuelo
      * @param org aeropuerto de origen
      * @param hs hora de salida
      * @param ms minuto de salida
      * @param dst aeropuerto de destino
      * @param hl hora de llegada
      * @param ml minuto de llegada
      * @param esc numero de escalas (sin cambiar de avion)
      * Ejemplo: Vuelo("lan", 123, "clo", 10, 30, "scl", 12, 30, 0)
    */
